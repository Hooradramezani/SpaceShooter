...
class GameOverScene : SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        tittleLable1.text = "\(highScoreNumber)"
        tittleLable1.fontSize = 100
        tittleLable1.fontColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1)
        ...
        tittleLable11.position = CGPoint(x: self.size.width/2, y: self.size.height*0.59)
        ...
        tittleLable21.text = "Tap The Restart And Try Again !"
